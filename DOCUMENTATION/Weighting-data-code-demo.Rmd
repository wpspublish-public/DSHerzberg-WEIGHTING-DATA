...
We read in two simulated data sets, each includeing 1000 cases with the four demographic variables of interest, and 50 behavior rating items coded as described above. 
...
###### COMMENTED SNIPPETS
Because some downstream procedures invoke R's random number generator, we use `base::set.seed()` to ensure that we get the same numerical results every time we run the script.
